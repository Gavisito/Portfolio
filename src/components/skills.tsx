...
import { SiMongodb, SiTypescript, SiNextdotjs, SiTailwindcss, SiChartdotjs, SiExpress, SiMysql, SiPostman, SiContentful, SiVercel, SiVite} from "react-icons/si";
...
export default function Skills() {
    ...
    return (
        <article className="skills" id='skills' ref={ref}>
